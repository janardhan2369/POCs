...
| --------- | --------------- | ------------ | --------- |
| DC1_LEAF1 | Vlan4094 | 10.1.5.0 | Port-Channel9 |
...
| --------- | ----------- | ---- | ----- | ----------- | ----------- | ------------- |
| Ethernet5 | dc1-Leaf1-Po11_Eth2/1 | *trunk | *101-102, 201-202, 301-302 | *- | *- | 5 |
| Ethernet9 | MLAG_PEER_dc1-leaf1a-cal418_Ethernet9 | *trunk | *- | *- | *['LEAF_PEER_L3', 'MLAG'] | 9 |
...
| --------- | ----------- | -----| ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet1 | dc1-spine1a-wps323-Ethernet2/1 | routed | - | 161.1.0.3/31 | default | 9214 | False | - | - |
...
!
interface Ethernet1
   description dc1-spine1a-wps323-Ethernet2/1
   no shutdown
   mtu 9214
   no switchport
...
!
interface Ethernet5
   description dc1-Leaf1-Po11_Eth2/1
   no shutdown
   channel-group 5 mode active
!
interface Ethernet9
   description MLAG_PEER_dc1-leaf1a-cal418_Ethernet9
   no shutdown
...
| Port-Channel9 | MLAG_PEER_dc1-leaf1a-cal418_Po9 | switched | trunk | - | - | ['LEAF_PEER_L3', 'MLAG'] | - | - | - | - |
...
interface Port-Channel9
   description MLAG_PEER_dc1-leaf1a-cal418_Po9
   no shutdown
   switchport
   switchport mode trunk
...
| Loopback101 | alpha_VTEP_DIAGNOSTICS | alpha | 11.255.1.4/32 |
| Loopback102 | beta_VTEP_DIAGNOSTICS | beta | 11.255.2.4/32 |
...
| Vlan4050 |  alpha  |  10.2.5.1/31  |  -  |  -  |  -  |  -  |  -  |
| Vlan4051 |  beta  |  10.2.5.1/31  |  -  |  -  |  -  |  -  |  -  |
...
!
interface Vxlan1
   description dc1-leaf1b-cal419_VTEP
...
| 10.2.5.0 | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | alpha | - | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | - | - | - | - | - |
| 10.2.5.0 | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | beta | - | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | - | - | - | - | - |
...
| ----------------- | ------------------- | ----------------- | ------------------- | ------------------- | ------------ | ----- |
| alpha | 150.1.1.4:11 | 11:11 | - | - | learned | 101-102 |
| beta | 150.1.1.4:12 | 12:12 | - | - | learned | 201-202 |
| l2-gamma-vrf | 150.1.1.4:10301 | 10301:10301 | - | - | learned | 301-302 |

#### Router BGP VRFs

| VRF | Route-Distinguisher | Redistribute | EVPN Multicast |
| --- | ------------------- | ------------ | -------------- |
| alpha | 150.1.1.4:1 | connected | IPv4: True<br>Transit: False |
| beta | 150.1.1.4:2 | connected | IPv4: True<br>Transit: False |
...
router bgp 64111
   ...
   neighbor MLAG-IPv4-UNDERLAY-PEER description dc1-leaf1a-cal418
   neighbor MLAG-IPv4-UNDERLAY-PEER send-community
   neighbor MLAG-IPv4-UNDERLAY-PEER maximum-routes 12000
   neighbor MLAG-IPv4-UNDERLAY-PEER route-map RM-MLAG-PEER-IN in
   neighbor 10.2.5.0 peer group MLAG-IPv4-UNDERLAY-PEER
   neighbor 10.2.5.0 description dc1-leaf1a-cal418
   ...
   neighbor 161.1.0.2 description dc1-spine1a-wps323_Ethernet2/1
...
```eos
!
ip address virtual source-nat vrf alpha address 11.255.1.4
ip address virtual source-nat vrf beta address 11.255.2.4
```
