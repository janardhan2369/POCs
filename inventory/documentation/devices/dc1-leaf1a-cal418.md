...
| --------- | --------------- | ------------ | --------- |
| DC1_LEAF1 | Vlan4094 | 10.1.5.1 | Port-Channel9 |
...
| 301 | l2-gamma-vrf | - |
| 302 | l2-gamma-vrf | - |
| 4050 | MLAG_iBGP_alpha | LEAF_PEER_L3 |
| 4051 | MLAG_iBGP_beta | LEAF_PEER_L3 |
...
| --------- | ----------- | ---- | ----- | ----------- | ----------- | ------------- |
| Ethernet5 | dc1-Leaf1-Po11_Eth1/1 | *trunk | *101-102, 201-202, 301-302 | *- | *- | 5 |
| Ethernet9 | MLAG_PEER_dc1-leaf1b-cal419_Ethernet9 | *trunk | *- | *- | *['LEAF_PEER_L3', 'MLAG'] | 9 |
...
| --------- | ----------- | -----| ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet1 | dc1-spine1a-wps323-Ethernet1/1 | routed | - | 161.1.0.1/31 | default | 9214 | False | - | - |
...
!
interface Ethernet1
   description dc1-spine1a-wps323-Ethernet1/1
   no shutdown
   mtu 9214
   no switchport
...
!
interface Ethernet5
   description dc1-Leaf1-Po11_Eth1/1
   no shutdown
   channel-group 5 mode active
!
interface Ethernet9
   description MLAG_PEER_dc1-leaf1b-cal419_Ethernet9
   no shutdown
...
| --------- | ----------- | ---- | ---- | ----- | ----------- | ------------| --------------------- | ------------------ | ------- | -------- |
| Port-Channel5 | dc1-Leaf1-Po11_PO11 | switched | trunk | 101-102, 201-202, 301-302 | - | - | - | - | 5 | - |
| Port-Channel9 | MLAG_PEER_dc1-leaf1b-cal419_Po9 | switched | trunk | - | - | ['LEAF_PEER_L3', 'MLAG'] | - | - | - | - |
...
interface Port-Channel5
   description dc1-Leaf1-Po11_PO11
   no shutdown
   switchport
...
interface Port-Channel9
   description MLAG_PEER_dc1-leaf1b-cal419_Po9
   no shutdown
   switchport
   switchport mode trunk
...
| Loopback101 | alpha_VTEP_DIAGNOSTICS | alpha | 11.255.1.3/32 |
| Loopback102 | beta_VTEP_DIAGNOSTICS | beta | 11.255.2.3/32 |
...
| Vlan4050 | MLAG_PEER_L3_iBGP: vrf alpha | alpha | 9214 | False |
| Vlan4051 | MLAG_PEER_L3_iBGP: vrf beta | beta | 9214 | False |
...
| Vlan4050 |  alpha  |  10.2.5.0/31  |  -  |  -  |  -  |  -  |  -  |
| Vlan4051 |  beta  |  10.2.5.0/31  |  -  |  -  |  -  |  -  |  -  |
...
!
interface Vlan4050
   description MLAG_PEER_L3_iBGP: vrf alpha
   no shutdown
   mtu 9214
   vrf alpha
...
!
interface Vlan4051
   description MLAG_PEER_L3_iBGP: vrf beta
   no shutdown
   mtu 9214
   vrf beta
   ip address 10.2.5.0/31
...
!
interface Vxlan1
   description dc1-leaf1a-cal418_VTEP
...
| 10.2.5.1 | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | alpha | - | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | - | - | - | - | - |
| 10.2.5.1 | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | beta | - | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | - | - | - | - | - |
...
| ----------------- | ------------------- | ----------------- | ------------------- | ------------------- | ------------ | ----- |
| alpha | 150.1.1.3:11 | 11:11 | - | - | learned | 101-102 |
| beta | 150.1.1.3:12 | 12:12 | - | - | learned | 201-202 |
| l2-gamma-vrf | 150.1.1.3:10301 | 10301:10301 | - | - | learned | 301-302 |

#### Router BGP VRFs

| VRF | Route-Distinguisher | Redistribute | EVPN Multicast |
| --- | ------------------- | ------------ | -------------- |
| alpha | 150.1.1.3:1 | connected | IPv4: True<br>Transit: False |
| beta | 150.1.1.3:2 | connected | IPv4: True<br>Transit: False |
...
router bgp 64111
   ...
   neighbor MLAG-IPv4-UNDERLAY-PEER description dc1-leaf1b-cal419
   neighbor MLAG-IPv4-UNDERLAY-PEER send-community
   neighbor MLAG-IPv4-UNDERLAY-PEER maximum-routes 12000
   neighbor MLAG-IPv4-UNDERLAY-PEER route-map RM-MLAG-PEER-IN in
   neighbor 10.2.5.1 peer group MLAG-IPv4-UNDERLAY-PEER
   neighbor 10.2.5.1 description dc1-leaf1b-cal419
   ...
   neighbor 161.1.0.0 description dc1-spine1a-wps323_Ethernet1/1
...
| -------------- | -------- | ---------- | ----------- | --------------- |
| Ethernet1 | - | IPv4 | - | - |
| Vlan101 | alpha | IPv4 | - | Loopback101 |
| Vlan102 | alpha | IPv4 | - | Loopback101 |
| Vlan201 | beta | IPv4 | - | Loopback102 |
| Vlan202 | beta | IPv4 | - | Loopback102 |
| Vlan4093 | - | IPv4 | - | - |
...
```eos
!
ip address virtual source-nat vrf alpha address 11.255.1.3
ip address virtual source-nat vrf beta address 11.255.2.3
```
