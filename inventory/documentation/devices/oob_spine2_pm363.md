...
| -------------------- | ----------- | ---- | --- | ---------- | ------- |
| Management1 | oob_management | oob | MGMT | 172.28.135.234/20 | 172.28.128.1 |
...
| --------- | --------------- | ------------ | --------- |
| DC1P1_OOB_SPINE | Vlan4094 | 10.5.5.0 | Port-Channel2 |
...
| --------- | ----------- | ---- | ----- | ----------- | ----------- | ------------- |
| Ethernet2 | MLAG_PEER_oob_spine1_pm362_Ethernet2 | *trunk | *- | *- | *['MLAG'] | 2 |
| Ethernet3 | MLAG_PEER_oob_spine1_pm362_Ethernet3 | *trunk | *- | *- | *['MLAG'] | 2 |
...
!
interface Ethernet2
   description MLAG_PEER_oob_spine1_pm362_Ethernet2
   no shutdown
   channel-group 2 mode active
!
interface Ethernet3
   description MLAG_PEER_oob_spine1_pm362_Ethernet3
   no shutdown
   channel-group 2 mode active
!
interface ethernet4
...
| --------- | ----------- | ---- | ---- | ----- | ----------- | ------------| --------------------- | ------------------ | ------- | -------- |
| Port-Channel2 | MLAG_PEER_oob_spine1_pm362_Po2 | switched | trunk | - | - | ['MLAG'] | - | - | - | - |
...
interface Port-Channel2
   description MLAG_PEER_oob_spine1_pm362_Po2
   no shutdown
   switchport
