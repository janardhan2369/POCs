...
| -------------------- | ----------- | ---- | --- | ---------- | ------- |
| Management1 | oob_management | oob | MGMT | 172.28.132.96/20 | 172.28.128.1 |
...
| --------- | ----------- | -----| ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet49/1 | P2P_LINK_TO_HS426_Ethernet51/1 | routed | - | 172.31.255.9/31 | default | 9214 | false | - | - |
| Ethernet50/1 | P2P_LINK_TO_HS427_Ethernet51/1 | routed | - | 172.31.255.11/31 | default | 9214 | false | - | - |
...
interface Ethernet49/1
   description P2P_LINK_TO_HS426_Ethernet51/1
   no shutdown
   mtu 9214
   no switchport
...
interface Ethernet50/1
   description P2P_LINK_TO_HS427_Ethernet51/1
   no shutdown
   mtu 9214
   no switchport
...
| ----------------- | ------------------- | ----------------- | ------------------- | ------------------- | ------------ | ----- |
| Tenant_A | 192.168.255.5:101 | 101:101 | - | - | learned | 1101-1110 |
| Tenant_B | 192.168.255.5:102 | 102:102 | - | - | learned | 1201-1210 |

### Router BGP VLANs

| VLAN | Route-Distinguisher | Both Route-Target | Import Route Target | Export Route-Target | Redistribute |
| ---- | ------------------- | ----------------- | ------------------- | ------------------- | ------------ |
| 100 | 3.3.3.3:10100 | 10100:10100 | - | - | learned<br>no host-route |
| 200 | 3.3.3.3:10200 | 10200:10200 | - | - | learned<br>no host-route |

### Router BGP VRFs

| VRF | Route-Distinguisher | Redistribute |
| --- | ------------------- | ------------ |
| Tenant_A | 192.168.255.5:101 | connected |
| Tenant_B | 192.168.255.5:102 | connected |
...
router bgp 65103
   ...
   neighbor 172.31.255.8 description hs426_Ethernet51/1
   neighbor 172.31.255.10 peer group IPv4-UNDERLAY-PEERS
   neighbor 172.31.255.10 remote-as 65001
   neighbor 172.31.255.10 description hs427_Ethernet51/1
