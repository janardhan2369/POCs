...
| -------------------- | ----------- | ---- | --- | ---------- | ------- |
| Management1 | oob_management | oob | MGMT | 172.28.128.68/20 | 172.28.128.1 |
...
| --------- | ----------- | -----| ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet1/1 | P2P_LINK_TO_dc1p1_spine1_glf437_Ethernet2/1/1 | routed | - | 162.5.1.1/31 | default | 9214 | False | - | - |
| Ethernet2/1 | P2P_LINK_TO_dc2p1_spine1_ghs282_Ethernet2/1 | routed | - | 162.5.1.12/31 | default | 9214 | False | - | - |
| Ethernet3/1 | dc1p2_leaf1_mrv453-Ethernet49/1 | routed | - | 161.1.0.42/31 | default | 9214 | False | - | - |
| Ethernet4/1 | dc1p2_leaf2_gt272-Ethernet49/1 | routed | - | 161.1.0.48/31 | default | 9214 | False | - | - |
...
interface Ethernet1/1
   description P2P_LINK_TO_dc1p1_spine1_glf437_Ethernet2/1/1
   no shutdown
   mtu 9214
   speed 100g
   no switchport
...
interface Ethernet2/1
   description P2P_LINK_TO_dc2p1_spine1_ghs282_Ethernet2/1
   no shutdown
   mtu 9214
   speed 100g
   no switchport
...
interface Ethernet3/1
   description dc1p2_leaf1_mrv453-Ethernet49/1
   no shutdown
   mtu 9214
   no switchport
...
interface Ethernet4/1
   description dc1p2_leaf2_gt272-Ethernet49/1
   no shutdown
   mtu 9214
   no switchport
...
| --------- | ----------- | --- | ---- | -------- |
| Vlan12 | ixia-bgp-underlay-rtr-peer | default | - | - |

##### IPv4

| Interface | VRF | IP Address | IP Address Virtual | IP Router Virtual Address | VRRP | ACL In | ACL Out |
| --------- | --- | ---------- | ------------------ | ------------------------- | ---- | ------ | ------- |
| Vlan12 |  default  |  163.1.1.0/31  |  -  |  -  |  -  |  -  |  -  |
...
| ------ | ------------------------- | ---------- | ----------- | --------- | --- |
| 101.2.1.0/24 | - | EVPN-OVERLAY-PEERS | ixia-vtep-scale | - | default |
...
| 162.5.1.13 | 63313 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - | - |
| 163.1.1.1 | 1002 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - | - |
...
router bgp 63312
   ...
   graceful-restart restart-time 300
   graceful-restart
   bgp listen range 101.2.1.0/24 peer-group EVPN-OVERLAY-PEERS peer-filter ixia-vtep-scale
   ...
   neighbor 150.2.1.10 description dc1p2_leaf1_mrv453
   neighbor 150.2.2.11 peer group EVPN-OVERLAY-PEERS
   neighbor 150.2.2.11 remote-as 64117
   neighbor 150.2.2.11 description dc1p2_leaf2_gt272
   ...
   neighbor 161.1.0.43 description dc1p2_leaf1_mrv453_Ethernet49/1
   neighbor 161.1.0.49 peer group IPv4-UNDERLAY-PEERS
   neighbor 161.1.0.49 remote-as 64117
   neighbor 161.1.0.49 description dc1p2_leaf2_gt272_Ethernet49/1
   neighbor 162.5.1.0 peer group IPv4-UNDERLAY-PEERS
   neighbor 162.5.1.0 remote-as 63311
   neighbor 162.5.1.0 description dc1p1_spine1_glf437
   neighbor 162.5.1.13 peer group IPv4-UNDERLAY-PEERS
   neighbor 162.5.1.13 remote-as 63313
   neighbor 162.5.1.13 description dc2p1_spine1_ghs282
   neighbor 163.1.1.1 peer group IPv4-UNDERLAY-PEERS
   neighbor 163.1.1.1 remote-as 1002
   neighbor 163.1.1.1 description dc1p2-ixia-underlay-rtr
...
| Sequence | Match |
| -------- | ----- |
| 10 | as-range 2101-2199 result accept |
...
peer-filter ixia-vtep-scale
   10 match as-range 2101-2199 result accept
```
...
monitor telemetry postcard policy
 ...
 ingress collection gre source 150.9.2.4 destination 127.0.0.1
 !
