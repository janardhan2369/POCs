...
| -------------------- | ----------- | ---- | --- | ---------- | ------- |
| Management1 | oob_management | oob | MGMT | 172.28.132.96/24 | 172.28.128.1 |
...
| --------- | --------------- | ------------ | --------- |
| DC1_LEAF2 | Vlan4094 | 10.255.252.5 | Port-Channel531 |
...
| --------- | ----------- | ---- | ----- | ----------- | ----------- | ------------- |
| Ethernet53/1 | MLAG_PEER_DC1-LEAF2B_Ethernet53/1 | *trunk | *2-4094 | *- | *['LEAF_PEER_L3', 'MLAG'] | 531 |
| Ethernet54/1 | MLAG_PEER_DC1-LEAF2B_Ethernet54/1 | *trunk | *2-4094 | *- | *['LEAF_PEER_L3', 'MLAG'] | 531 |
...
| --------- | ----------- | -----| ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet49/1 | P2P_LINK_TO_DC1-SPINE1_Ethernet51/1 | routed | - | 172.31.255.9/31 | default | 1500 | false | - | - |
| Ethernet50/1 | P2P_LINK_TO_DC1-SPINE2_Ethernet51/1 | routed | - | 172.31.255.11/31 | default | 1500 | false | - | - |
...
interface Ethernet49/1
   description P2P_LINK_TO_DC1-SPINE1_Ethernet51/1
   no shutdown
   mtu 1500
   no switchport
...
interface Ethernet50/1
   description P2P_LINK_TO_DC1-SPINE2_Ethernet51/1
   no shutdown
   mtu 1500
   no switchport
...
interface Ethernet53/1
   description MLAG_PEER_DC1-LEAF2B_Ethernet53/1
   no shutdown
   channel-group 531 mode active
!
interface Ethernet54/1
   description MLAG_PEER_DC1-LEAF2B_Ethernet54/1
   no shutdown
   channel-group 531 mode active
```
...
| --------- | ----------- | ---- | ---- | ----- | ----------- | ------------| --------------------- | ------------------ | ------- | -------- |
| Port-Channel531 | MLAG_PEER_DC1-LEAF2B_Po531 | switched | trunk | 2-4094 | - | ['LEAF_PEER_L3', 'MLAG'] | - | - | - | - |
...
interface Port-Channel531
   description MLAG_PEER_DC1-LEAF2B_Po531
   no shutdown
   switchport
...
router bgp 65102
   ...
   neighbor 172.31.255.8 description DC1-SPINE1_Ethernet51/1
   neighbor 172.31.255.10 peer group IPv4-UNDERLAY-PEERS
   neighbor 172.31.255.10 remote-as 65001
   neighbor 172.31.255.10 description DC1-SPINE2_Ethernet51/1
