...
| -------------------- | ----------- | ---- | --- | ---------- | ------- |
| Management1 | oob_management | oob | MGMT | 172.28.143.78/20 | 172.28.128.1 |
...
| --------- | --------------- | ------------ | --------- |
| DC2_LEAF1 | Vlan4094 | 10.255.252.1 | Port-Channel531 |
...
| Ethernet53/1 | MLAG_PEER_cal372-dc2_Ethernet53/1 | *trunk | *2-4094 | *- | *['LEAF_PEER_L3', 'MLAG'] | 531 |
| Ethernet54/1 | MLAG_PEER_cal372-dc2_Ethernet54/1 | *trunk | *2-4094 | *- | *['LEAF_PEER_L3', 'MLAG'] | 531 |
...
| --------- | ----------- | -----| ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet49/1 | P2P_LINK_TO_HS426-DC2_Ethernet49/1 | routed | - | 172.32.255.1/31 | default | 9214 | false | - | - |
| Ethernet50/1 | P2P_LINK_TO_HS427-DC2_Ethernet49/1 | routed | - | 172.32.255.3/31 | default | 9214 | false | - | - |
...
interface Ethernet49/1
   description P2P_LINK_TO_HS426-DC2_Ethernet49/1
   no shutdown
   mtu 9214
   no switchport
...
interface Ethernet50/1
   description P2P_LINK_TO_HS427-DC2_Ethernet49/1
   no shutdown
   mtu 9214
   no switchport
...
interface Ethernet53/1
   description MLAG_PEER_cal372-dc2_Ethernet53/1
   no shutdown
   channel-group 531 mode active
!
interface Ethernet54/1
   description MLAG_PEER_cal372-dc2_Ethernet54/1
   no shutdown
   channel-group 531 mode active
```
...
| Port-Channel531 | MLAG_PEER_cal372-dc2_Po531 | switched | trunk | 2-4094 | - | ['LEAF_PEER_L3', 'MLAG'] | - | - | - | - |
...
interface Port-Channel531
   description MLAG_PEER_cal372-dc2_Po531
   no shutdown
   switchport
...
| Vlan3900 |  Tenant_A  |  10.255.251.0/31  |  -  |  -  |  -  |  -  |  -  |
| Vlan3901 |  Tenant_B  |  10.255.251.0/31  |  -  |  -  |  -  |  -  |  -  |
...
| 172.32.255.0 | 65201 | default | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - |
| 172.32.255.2 | 65201 | default | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - |
...
| 10.255.251.1 | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | Tenant_A | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | - | - |
| 10.255.251.1 | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | Tenant_B | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | - | - |
...
| ----------------- | ------------------- | ----------------- | ------------------- | ------------------- | ------------ | ----- |
| Tenant_A | 192.168.251.3:101 | 101:101 | - | - | learned | 1101-1110 |
| Tenant_B | 192.168.251.3:102 | 102:102 | - | - | learned | 1201-1210 |

### Router BGP VRFs

| VRF | Route-Distinguisher | Redistribute |
| --- | ------------------- | ------------ |
| Tenant_A | 192.168.251.3:101 | connected |
| Tenant_B | 192.168.251.3:102 | connected |
...
router bgp 65301
   ...
   neighbor 10.255.251.1 description cal372-dc2
   neighbor 172.32.255.0 peer group IPv4-UNDERLAY-PEERS
   neighbor 172.32.255.0 remote-as 65201
   neighbor 172.32.255.0 description hs426-dc2_Ethernet49/1
   neighbor 172.32.255.2 peer group IPv4-UNDERLAY-PEERS
   neighbor 172.32.255.2 remote-as 65201
   neighbor 172.32.255.2 description hs427-dc2_Ethernet49/1
