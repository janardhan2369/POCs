...
| -------------------- | ----------- | ---- | --- | ---------- | ------- |
| Management1 | oob_management | oob | MGMT | 172.28.131.100/20 | 172.28.128.1 |
...
| --------- | ----------- | -----| ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet1/1 | P2P_LINK_TO_dc1p1_spine2_btp454_Ethernet2/1 | routed | - | 162.5.1.7/31 | default | 9214 | False | - | - |
| Ethernet2/1 | P2P_LINK_TO_dc1p2_spine2_ghs278_Ethernet2/1 | routed | - | 162.5.1.15/31 | default | 9214 | False | - | - |
| Ethernet3/1 | dc2p1_leaf1a_mrv305-Ethernet50/1 | routed | - | 161.1.0.56/31 | default | 9214 | False | - | - |
| Ethernet4/1 | dc2p1_leaf1b_mrv306-Ethernet50/1 | routed | - | 161.1.0.62/31 | default | 9214 | False | - | - |
| Ethernet6/1 | dc2p1_sleaf_gt407-Ethernet50/1 | routed | - | 161.1.0.68/31 | default | 9214 | False | - | - |
...
interface Ethernet1/1
   description P2P_LINK_TO_dc1p1_spine2_btp454_Ethernet2/1
   no shutdown
   mtu 9214
   speed 100g
   no switchport
   ip address 162.5.1.7/31
   pim ipv4 sparse-mode

!
interface Ethernet2/1
   description P2P_LINK_TO_dc1p2_spine2_ghs278_Ethernet2/1
   no shutdown
   mtu 9214
   speed 100g
   no switchport
   ip address 162.5.1.15/31
   pim ipv4 sparse-mode

!
interface Ethernet3/1
   description dc2p1_leaf1a_mrv305-Ethernet50/1
   no shutdown
   mtu 9214
   no switchport
   ip address 161.1.0.56/31
   pim ipv4 sparse-mode
!
interface Ethernet4/1
   description dc2p1_leaf1b_mrv306-Ethernet50/1
   no shutdown
   mtu 9214
   no switchport
   ip address 161.1.0.62/31
   pim ipv4 sparse-mode
!
interface Ethernet6/1
   description dc2p1_sleaf_gt407-Ethernet50/1
   no shutdown
   mtu 9214
   no switchport
   ip address 161.1.0.68/31
   pim ipv4 sparse-mode
```
...
| --------- | ----------- | --- | ---------- |
| Loopback0 | EVPN_Overlay_Peering | default | 150.9.3.8/32 |
...
| 161.1.0.57 | 64211 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - | - |
| 161.1.0.63 | 64211 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - | - |
| 161.1.0.69 | 64212 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - | - |
| 162.5.1.6 | 63311 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - | - |
| 162.5.1.14 | 63312 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - | - |
...
router bgp 63321
   ...
   neighbor 150.9.1.2 description dc1p1-spine2-btp454
   ...
   neighbor 161.1.0.57 peer group IPv4-UNDERLAY-PEERS
   neighbor 161.1.0.57 remote-as 64211
   neighbor 161.1.0.57 description dc2p1_leaf1a_mrv305_Ethernet50/1
   neighbor 161.1.0.63 peer group IPv4-UNDERLAY-PEERS
   neighbor 161.1.0.63 remote-as 64211
   neighbor 161.1.0.63 description dc2p1_leaf1b_mrv306_Ethernet50/1
   neighbor 161.1.0.69 peer group IPv4-UNDERLAY-PEERS
   neighbor 161.1.0.69 remote-as 64212
   neighbor 161.1.0.69 description dc2p1_sleaf_gt407_Ethernet50/1
   neighbor 162.5.1.6 peer group IPv4-UNDERLAY-PEERS
   neighbor 162.5.1.6 remote-as 63311
   neighbor 162.5.1.6 local-as 63313 no-prepend replace-as
   neighbor 162.5.1.6 description dc1p1_spine2_btp454
   neighbor 162.5.1.14 peer group IPv4-UNDERLAY-PEERS
   neighbor 162.5.1.14 remote-as 63312
   neighbor 162.5.1.14 local-as 63313 no-prepend replace-as
   neighbor 162.5.1.14 description dc1p2_spine2_ghs278
...
monitor telemetry postcard policy
 ...
 ingress collection gre source 150.9.3.8 destination 127.0.0.1
 !
