...
| -------------------- | ----------- | ---- | --- | ---------- | ------- |
| Management1 | oob_management | oob | MGMT | 172.28.131.47/20 | 172.28.128.1 |
...
| --------- | ----------- | -----| ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet49/1 | P2P_LINK_TO_HS426_Ethernet52/1 | routed | - | 172.31.255.13/31 | default | 9214 | false | - | - |
| Ethernet50/1 | P2P_LINK_TO_HS427_Ethernet52/1 | routed | - | 172.31.255.15/31 | default | 9214 | false | - | - |
...
interface Ethernet49/1
   description P2P_LINK_TO_HS426_Ethernet52/1
   no shutdown
   mtu 9214
   no switchport
...
interface Ethernet50/1
   description P2P_LINK_TO_HS427_Ethernet52/1
   no shutdown
   mtu 9214
   no switchport
...
| --------- | ----------- | ---- | ---- | ----- | ----------- | ------------| --------------------- | ------------------ | ------- | -------- |
| Port-Channel1 | HarnessB_Eth3-4 | switched | trunk | - | - | - | - | - | - | 0000:0000:0101:0202:0202 |
...
interface Port-Channel1
   ...
   evpn ethernet-segment
      identifier 0000:0000:0101:0202:0202
      route-target import 01:01:02:02:02:02
   lacp system-id 0101.0202.0202
```
...
| ----------------- | ------------------- | ----------------- | ------------------- | ------------------- | ------------ | ----- |
| Tenant_A | 192.168.255.6:101 | 101:101 | - | - | learned | 1101-1110 |
| Tenant_B | 192.168.255.6:102 | 102:102 | - | - | learned | 1201-1210 |

### Router BGP VLANs

| VLAN | Route-Distinguisher | Both Route-Target | Import Route Target | Export Route-Target | Redistribute |
| ---- | ------------------- | ----------------- | ------------------- | ------------------- | ------------ |
| 100 | 4.4.4.4:10100 | 10100:10100 | - | - | learned<br>no host-route |
| 200 | 4.4.4.4:10200 | 10200:10200 | - | - | learned<br>no host-route |

### Router BGP VRFs

| VRF | Route-Distinguisher | Redistribute |
| --- | ------------------- | ------------ |
| Tenant_A | 192.168.255.6:101 | connected |
| Tenant_B | 192.168.255.6:102 | connected |
...
router bgp 65104
   ...
   neighbor 172.31.255.12 description hs426_Ethernet52/1
   neighbor 172.31.255.14 peer group IPv4-UNDERLAY-PEERS
   neighbor 172.31.255.14 remote-as 65001
   neighbor 172.31.255.14 description hs427_Ethernet52/1
