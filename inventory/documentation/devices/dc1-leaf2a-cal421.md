...
| --------- | ----------- | ---- | ----- | ----------- | ----------- | ------------- |
| Ethernet5 | dc1-Leaf2-Po12_Eth3/1 | *trunk | *101-102, 201-202, 301-302 | *- | *- | 5 |
...
| --------- | ----------- | -----| ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet1 | dc1-spine1a-wps323-Ethernet3/1 | routed | - | 161.1.0.5/31 | default | 9214 | False | - | - |
...
!
interface Ethernet1
   description dc1-spine1a-wps323-Ethernet3/1
   no shutdown
   mtu 9214
   no switchport
...
!
interface Ethernet5
   description dc1-Leaf2-Po12_Eth3/1
   no shutdown
...
| Loopback101 | alpha_VTEP_DIAGNOSTICS | alpha | 11.255.1.5/32 |
| Loopback102 | beta_VTEP_DIAGNOSTICS | beta | 11.255.2.5/32 |
...
!
interface Vxlan1
   description dc1-leaf2a-cal421_VTEP
...
| ----------------- | ------------------- | ----------------- | ------------------- | ------------------- | ------------ | ----- |
| alpha | 150.1.2.5:11 | 11:11 | - | - | learned | 101-102 |
| beta | 150.1.2.5:12 | 12:12 | - | - | learned | 201-202 |
| l2-gamma-vrf | 150.1.2.5:10301 | 10301:10301 | - | - | learned | 301-302 |

#### Router BGP VRFs

| VRF | Route-Distinguisher | Redistribute | EVPN Multicast |
| --- | ------------------- | ------------ | -------------- |
| alpha | 150.1.2.5:1 | connected | IPv4: True<br>Transit: False |
| beta | 150.1.2.5:2 | connected | IPv4: True<br>Transit: False |
...
router bgp 64112
   ...
   neighbor 161.1.0.4 description dc1-spine1a-wps323_Ethernet3/1
...
```eos
!
ip address virtual source-nat vrf alpha address 11.255.1.5
ip address virtual source-nat vrf beta address 11.255.2.5
```
