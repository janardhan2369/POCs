...
| -------------------- | ----------- | ---- | --- | ---------- | ------- |
| Management1 | oob_management | oob | MGMT | 172.28.132.88/20 | 172.28.128.1 |
...
| --------- | --------------- | ------------ | --------- |
| DC1_GWleaf | Vlan4094 | 10.255.252.21 | Port-Channel10 |
...
| --------- | ----------- | ---- | ----- | ----------- | ----------- | ------------- |
| Ethernet10 | MLAG_PEER_hs430_Ethernet10 | *trunk | *2-4094 | *- | *['LEAF_PEER_L3', 'MLAG'] | 10 |
| Ethernet11 | MLAG_PEER_hs430_Ethernet11 | *trunk | *2-4094 | *- | *['LEAF_PEER_L3', 'MLAG'] | 10 |
...
| --------- | ----------- | -----| ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet1 | P2P_LINK_TO_HS426_Ethernet1 | routed | - | 172.32.250.41/31 | default | 9214 | false | - | - |
| Ethernet3 | P2P_LINK_TO_HS427_Ethernet2 | routed | - | 172.32.250.43/31 | default | 9214 | false | - | - |
| Ethernet52/1 | P2P_LINK_TO_GWleaf1-dc2_Ethernet52/1 | routed | - | 192.168.0.0/31 | default | 9214 | false | - | - |
...
interface Ethernet3
   ...
   mtu 9214
   no switchport
   ip address 172.32.250.43/31
!
interface Ethernet10
   description MLAG_PEER_hs430_Ethernet10
   no shutdown
   channel-group 10 mode active
!
interface Ethernet11
   description MLAG_PEER_hs430_Ethernet11
   no shutdown
   channel-group 10 mode active
!
interface Ethernet52/1
   description P2P_LINK_TO_GWleaf1-dc2_Ethernet52/1
   no shutdown
...
| --------- | ----------- | ---- | ---- | ----- | ----------- | ------------| --------------------- | ------------------ | ------- | -------- |
| Port-Channel10 | MLAG_PEER_hs430_Po10 | switched | trunk | 2-4094 | - | ['LEAF_PEER_L3', 'MLAG'] | - | - | - | - |
...
interface Port-Channel10
   description MLAG_PEER_hs430_Po10
   no shutdown
   switchport
...
| --------- | ----------- | --- | ---------- |
| Loopback0 | EVPN_Overlay_Peering | default | 192.168.253.13/32 |
| Loopback1 | VTEP_VXLAN_Tunnel_Source | default | 192.168.254.13/32 |
| Loopback101 | Tenant_A_VTEP_DIAGNOSTICS | Tenant_A | 11.1.255.13/32 |
| Loopback102 | Tenant_B_VTEP_DIAGNOSTICS | Tenant_B | 11.2.255.13/32 |
...
interface Loopback101
   ...
   no shutdown
   vrf Tenant_A
   ip address 11.1.255.13/32
!
interface Loopback102
   description Tenant_B_VTEP_DIAGNOSTICS
   no shutdown
   vrf Tenant_B
   ip address 11.2.255.13/32
```
...
| Vlan3100 |  Tenant_A  |  10.255.251.20/31  |  -  |  -  |  -  |  -  |  -  |
| Vlan3101 |  Tenant_B  |  10.255.251.20/31  |  -  |  -  |  -  |  -  |  -  |
...
| 172.32.250.40 | 65001 | default | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - |
| 172.32.250.42 | 65001 | default | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - |
| 192.168.0.1 | 65505 | default | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | True |
| 192.168.253.15 | - | default | - | - | - | - |
| 192.168.253.16 | - | default | - | - | - | - |
| 192.168.255.1 | 65001 | default | Inherited from peer group EVPN-OVERLAY-PEERS | Inherited from peer group EVPN-OVERLAY-PEERS | - | Inherited from peer group EVPN-OVERLAY-PEERS |
| 192.168.255.2 | 65001 | default | Inherited from peer group EVPN-OVERLAY-PEERS | Inherited from peer group EVPN-OVERLAY-PEERS | - | Inherited from peer group EVPN-OVERLAY-PEERS |
| 10.255.251.21 | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | Tenant_A | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | - | - |
...
| ----------------- | ------------------- | ----------------- | ------------------- | ------------------- | ------------ | ----- |
| Tenant_A | 192.168.253.13:101 | 101:101 | remote 101:101 | remote 101:101 | learned | 1101-1110 |
| Tenant_B | 192.168.253.13:102 | 102:102 | remote 102:102 | remote 102:102 | learned | 1201-1210 |

### Router BGP VLANs

| VLAN | Route-Distinguisher | Both Route-Target | Import Route Target | Export Route-Target | Redistribute |
| ---- | ------------------- | ----------------- | ------------------- | ------------------- | ------------ |
| 100 | 6.6.6.6:10100 | 10100:10100 | - | - | learned<br>no host-route |
| 200 | 6.6.6.6:10200 | 10200:10200 | - | - | learned<br>no host-route |

### Router BGP VRFs

| VRF | Route-Distinguisher | Redistribute |
| --- | ------------------- | ------------ |
| Tenant_A | 192.168.253.13:101 | connected |
| Tenant_B | 192.168.253.13:102 | connected |
...
router bgp 65501
   ...
   neighbor 10.255.251.21 description hs430
   neighbor 172.32.250.40 peer group IPv4-UNDERLAY-PEERS
   neighbor 172.32.250.40 remote-as 65001
   neighbor 172.32.250.40 description hs426_Ethernet1
   neighbor 172.32.250.42 peer group IPv4-UNDERLAY-PEERS
   neighbor 172.32.250.42 remote-as 65001
   neighbor 172.32.250.42 description hs427_Ethernet2
   neighbor 192.168.0.1 peer group IPv4-UNDERLAY-PEERS
   neighbor 192.168.0.1 remote-as 65505
   neighbor 192.168.0.1 local-as 65504 no-prepend replace-as
   neighbor 192.168.0.1 description GWleaf1-dc2
...
| -------------- | --------------------- |
| Tenant_A | 11.1.255.13 |
| Tenant_B | 11.2.255.13 |

## Virtual Source NAT Configuration

```eos
!
ip address virtual source-nat vrf Tenant_A address 11.1.255.13
ip address virtual source-nat vrf Tenant_B address 11.2.255.13
```
