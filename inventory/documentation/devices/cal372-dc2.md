...
| -------------------- | ----------- | ---- | --- | ---------- | ------- |
| Management1 | oob_management | oob | MGMT | 172.28.143.179/20 | 172.28.128.1 |
...
| --------- | --------------- | ------------ | --------- |
| DC2_LEAF1 | Vlan4094 | 10.255.252.0 | Port-Channel531 |
...
| 3900 | MLAG_iBGP_Tenant_A | LEAF_PEER_L3 |
| 3901 | MLAG_iBGP_Tenant_B | LEAF_PEER_L3 |
...
| --------- | ----------- | ---- | ----- | ----------- | ----------- | ------------- |
| Ethernet1 | HarnessA_Eth2 | *trunk | *- | *- | *- | 1 |
| Ethernet53/1 | MLAG_PEER_cal371-dc2_Ethernet53/1 | *trunk | *2-4094 | *- | *['LEAF_PEER_L3', 'MLAG'] | 531 |
| Ethernet54/1 | MLAG_PEER_cal371-dc2_Ethernet54/1 | *trunk | *2-4094 | *- | *['LEAF_PEER_L3', 'MLAG'] | 531 |
...
| --------- | ----------- | -----| ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet49/1 | P2P_LINK_TO_HS426-DC2_Ethernet50/1 | routed | - | 172.32.255.5/31 | default | 9214 | false | - | - |
| Ethernet50/1 | P2P_LINK_TO_HS427-DC2_Ethernet50/1 | routed | - | 172.32.255.7/31 | default | 9214 | false | - | - |
...
!
interface Ethernet1
   description HarnessA_Eth2
   no shutdown
   speed forced 10000full
   channel-group 1 mode active
!
interface Ethernet49/1
   description P2P_LINK_TO_HS426-DC2_Ethernet50/1
   no shutdown
   mtu 9214
   no switchport
...
interface Ethernet50/1
   description P2P_LINK_TO_HS427-DC2_Ethernet50/1
   no shutdown
   mtu 9214
   no switchport
...
interface Ethernet53/1
   description MLAG_PEER_cal371-dc2_Ethernet53/1
   no shutdown
   channel-group 531 mode active
!
interface Ethernet54/1
   description MLAG_PEER_cal371-dc2_Ethernet54/1
   no shutdown
   channel-group 531 mode active
```
...
| --------- | ----------- | ---- | ---- | ----- | ----------- | ------------| --------------------- | ------------------ | ------- | -------- |
| Port-Channel1 | HarnessA_Eth1-2 | switched | trunk | - | - | - | - | - | 1 | - |
| Port-Channel531 | MLAG_PEER_cal371-dc2_Po531 | switched | trunk | 2-4094 | - | ['LEAF_PEER_L3', 'MLAG'] | - | - | - | - |
...
interface Port-Channel531
   description MLAG_PEER_cal371-dc2_Po531
   no shutdown
   switchport
...
| Loopback101 | Tenant_A_VTEP_DIAGNOSTICS | Tenant_A | 11.1.255.4/32 |
| Loopback102 | Tenant_B_VTEP_DIAGNOSTICS | Tenant_B | 11.2.255.4/32 |
...
interface Loopback101
   ...
   no shutdown
   vrf Tenant_A
   ip address 11.1.255.4/32
!
interface Loopback102
   description Tenant_B_VTEP_DIAGNOSTICS
   no shutdown
   vrf Tenant_B
   ip address 11.2.255.4/32
```
...
| Vlan3900 |  MLAG_PEER_L3_iBGP: vrf Tenant_A  |  Tenant_A  |  9214  |  false  |
| Vlan3901 |  MLAG_PEER_L3_iBGP: vrf Tenant_B  |  Tenant_B  |  9214  |  false  |
...
| Vlan3900 |  Tenant_A  |  10.255.251.1/31  |  -  |  -  |  -  |  -  |  -  |
| Vlan3901 |  Tenant_B  |  10.255.251.1/31  |  -  |  -  |  -  |  -  |  -  |
...
| 172.32.255.4 | 65201 | default | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - |
| 172.32.255.6 | 65201 | default | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - |
...
| 10.255.251.0 | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | Tenant_A | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | - | - |
| 10.255.251.0 | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | Tenant_B | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | - | - |
...
| ----------------- | ------------------- | ----------------- | ------------------- | ------------------- | ------------ | ----- |
| Tenant_A | 192.168.251.4:101 | 101:101 | - | - | learned | 1101-1110 |
| Tenant_B | 192.168.251.4:102 | 102:102 | - | - | learned | 1201-1210 |

### Router BGP VRFs

| VRF | Route-Distinguisher | Redistribute |
| --- | ------------------- | ------------ |
| Tenant_A | 192.168.251.4:101 | connected |
| Tenant_B | 192.168.251.4:102 | connected |
...
router bgp 65301
   ...
   neighbor 10.255.251.0 description cal371-dc2
   neighbor 172.32.255.4 peer group IPv4-UNDERLAY-PEERS
   neighbor 172.32.255.4 remote-as 65201
   neighbor 172.32.255.4 description hs426-dc2_Ethernet50/1
   neighbor 172.32.255.6 peer group IPv4-UNDERLAY-PEERS
   neighbor 172.32.255.6 remote-as 65201
   neighbor 172.32.255.6 description hs427-dc2_Ethernet50/1
...
```eos
!
ip address virtual source-nat vrf Tenant_A address 11.1.255.4
ip address virtual source-nat vrf Tenant_B address 11.2.255.4
```
