...
| -------------------- | ----------- | ---- | --- | ---------- | ------- |
| Management1 | oob_management | oob | MGMT | 172.28.143.94/20 | 172.28.128.1 |
...
| --------- | ----------- | -----| ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet2 | P2P_LINK_TO_GWLEAF2-DC2_Ethernet3 | routed | - | 172.32.250.54/31 | default | 9214 | false | - | - |
...
!
interface Ethernet2
   description P2P_LINK_TO_GWLEAF2-DC2_Ethernet3
   no shutdown
   mtu 9214
   no switchport
   ip address 172.32.250.54/31
```
...
| -------- | --------- | --- | -------------- | -------------- | ---------- | --- |
| 172.32.250.55 | 65502 | default | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - |
...
router bgp 65002
   ...
   neighbor 172.32.250.55 peer group IPv4-UNDERLAY-PEERS
   neighbor 172.32.250.55 remote-as 65502
   neighbor 172.32.250.55 description GWleaf2-dc2_Ethernet3
