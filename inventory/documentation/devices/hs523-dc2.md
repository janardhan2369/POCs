...
| -------------------- | ----------- | ---- | --- | ---------- | ------- |
| Management1 | oob_management | oob | MGMT | 172.28.143.47/20 | 172.28.128.1 |
...
| --------- | ----------- | ---- | ----- | ----------- | ----------- | ------------- |
| Ethernet1 | HarnessB_Eth4 | *trunk | *- | *- | *- | 1 |
...
| --------- | ----------- | -----| ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet49/1 | P2P_LINK_TO_HS426-DC2_Ethernet52/1 | routed | - | 172.32.255.13/31 | default | 9214 | false | - | - |
| Ethernet50/1 | P2P_LINK_TO_HS427-DC2_Ethernet52/1 | routed | - | 172.32.255.15/31 | default | 9214 | false | - | - |
...
!
interface Ethernet1
   description HarnessB_Eth4
   no shutdown
   speed forced 10000full
   channel-group 1 mode active
!
interface Ethernet49/1
   description P2P_LINK_TO_HS426-DC2_Ethernet52/1
   no shutdown
   mtu 9214
   no switchport
...
interface Ethernet50/1
   description P2P_LINK_TO_HS427-DC2_Ethernet52/1
   no shutdown
   mtu 9214
   no switchport
...
| Loopback101 | Tenant_A_VTEP_DIAGNOSTICS | Tenant_A | 11.1.255.6/32 |
| Loopback102 | Tenant_B_VTEP_DIAGNOSTICS | Tenant_B | 11.2.255.6/32 |
...
interface Loopback101
   ...
   no shutdown
   vrf Tenant_A
   ip address 11.1.255.6/32
!
interface Loopback102
   description Tenant_B_VTEP_DIAGNOSTICS
   no shutdown
   vrf Tenant_B
   ip address 11.2.255.6/32
```
...
| -------- | --------- | --- | -------------- | -------------- | ---------- | --- |
| 172.32.255.12 | 65201 | default | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - |
| 172.32.255.14 | 65201 | default | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - |
...
| ----------------- | ------------------- | ----------------- | ------------------- | ------------------- | ------------ | ----- |
| Tenant_A | 192.168.251.6:101 | 101:101 | - | - | learned | 1101-1110 |
| Tenant_B | 192.168.251.6:102 | 102:102 | - | - | learned | 1201-1210 |

### Router BGP VRFs

| VRF | Route-Distinguisher | Redistribute |
| --- | ------------------- | ------------ |
| Tenant_A | 192.168.251.6:101 | connected |
| Tenant_B | 192.168.251.6:102 | connected |
...
router bgp 65302
   ...
   neighbor 172.32.255.12 remote-as 65201
   neighbor 172.32.255.12 description hs426-dc2_Ethernet52/1
   neighbor 172.32.255.14 peer group IPv4-UNDERLAY-PEERS
   neighbor 172.32.255.14 remote-as 65201
   neighbor 172.32.255.14 description hs427-dc2_Ethernet52/1
...
```eos
!
ip address virtual source-nat vrf Tenant_A address 11.1.255.6
ip address virtual source-nat vrf Tenant_B address 11.2.255.6
```
