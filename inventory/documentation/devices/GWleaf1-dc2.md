...
| -------------------- | ----------- | ---- | --- | ---------- | ------- |
| Management1 | oob_management | oob | MGMT | 172.28.143.88/20 | 172.28.128.1 |
...
| --------- | --------------- | ------------ | --------- |
| DC2_GWleaf | Vlan4094 | 10.255.252.25 | Port-Channel10 |
...
| --------- | ----------- | ---- | ----- | ----------- | ----------- | ------------- |
| Ethernet10 | MLAG_PEER_GWleaf2-dc2_Ethernet10 | *trunk | *2-4094 | *- | *['LEAF_PEER_L3', 'MLAG'] | 10 |
| Ethernet11 | MLAG_PEER_GWleaf2-dc2_Ethernet11 | *trunk | *2-4094 | *- | *['LEAF_PEER_L3', 'MLAG'] | 10 |
...
| --------- | ----------- | -----| ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet1 | P2P_LINK_TO_HS426-DC2_Ethernet1 | routed | - | 172.32.250.49/31 | default | 9214 | false | - | - |
| Ethernet3 | P2P_LINK_TO_HS427-DC2_Ethernet2 | routed | - | 172.32.250.51/31 | default | 9214 | false | - | - |
| Ethernet52/1 | P2P_LINK_TO_hs425_Ethernet52/1 | routed | - | 192.168.0.1/31 | default | 9214 | false | - | - |
...
interface Ethernet3
   ...
   mtu 9214
   no switchport
   ip address 172.32.250.51/31
!
interface Ethernet10
   description MLAG_PEER_GWleaf2-dc2_Ethernet10
   no shutdown
   channel-group 10 mode active
!
interface Ethernet11
   description MLAG_PEER_GWleaf2-dc2_Ethernet11
   no shutdown
   channel-group 10 mode active
!
interface Ethernet52/1
   description P2P_LINK_TO_hs425_Ethernet52/1
   no shutdown
...
| --------- | ----------- | ---- | ---- | ----- | ----------- | ------------| --------------------- | ------------------ | ------- | -------- |
| Port-Channel10 | MLAG_PEER_GWleaf2-dc2_Po10 | switched | trunk | 2-4094 | - | ['LEAF_PEER_L3', 'MLAG'] | - | - | - | - |
...
interface Port-Channel10
   description MLAG_PEER_GWleaf2-dc2_Po10
   no shutdown
   switchport
...
| --------- | ----------- | --- | ---------- |
| Loopback0 | EVPN_Overlay_Peering | default | 192.168.253.15/32 |
| Loopback1 | VTEP_VXLAN_Tunnel_Source | default | 192.168.254.15/32 |
| Loopback101 | Tenant_A_VTEP_DIAGNOSTICS | Tenant_A | 11.1.255.15/32 |
| Loopback102 | Tenant_B_VTEP_DIAGNOSTICS | Tenant_B | 11.2.255.15/32 |
...
interface Loopback101
   ...
   no shutdown
   vrf Tenant_A
   ip address 11.1.255.15/32
!
interface Loopback102
   description Tenant_B_VTEP_DIAGNOSTICS
   no shutdown
   vrf Tenant_B
   ip address 11.2.255.15/32
```
...
| Vlan3100 |  Tenant_A  |  10.255.251.24/31  |  -  |  -  |  -  |  -  |  -  |
| Vlan3101 |  Tenant_B  |  10.255.251.24/31  |  -  |  -  |  -  |  -  |  -  |
...
| 172.32.250.48 | 65002 | default | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - |
| 172.32.250.50 | 65002 | default | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - |
| 192.168.0.0 | 65504 | default | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | True |
...
| 10.255.251.25 | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | Tenant_A | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | - | - |
| 10.255.251.25 | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | Tenant_B | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | - | - |
...
| ----------------- | ------------------- | ----------------- | ------------------- | ------------------- | ------------ | ----- |
| Tenant_A | 192.168.253.15:101 | 101:101 | remote 101:101 | remote 101:101 | learned | 1101-1110 |
| Tenant_B | 192.168.253.15:102 | 102:102 | remote 102:102 | remote 102:102 | learned | 1201-1210 |
...
| --- | ------------------- | ------------ |
| Tenant_A | 192.168.253.15:101 | connected |
| Tenant_B | 192.168.253.15:102 | connected |
...
router bgp 65502
   ...
   neighbor 10.255.251.25 description GWleaf2-dc2
   neighbor 172.32.250.48 peer group IPv4-UNDERLAY-PEERS
   neighbor 172.32.250.48 remote-as 65002
   neighbor 172.32.250.48 description hs426-dc2_Ethernet1
   neighbor 172.32.250.50 peer group IPv4-UNDERLAY-PEERS
   neighbor 172.32.250.50 remote-as 65002
   neighbor 172.32.250.50 description hs427-dc2_Ethernet2
   neighbor 192.168.0.0 peer group IPv4-UNDERLAY-PEERS
   neighbor 192.168.0.0 remote-as 65504
   neighbor 192.168.0.0 local-as 65505 no-prepend replace-as
   neighbor 192.168.0.0 description hs425
   neighbor 192.168.0.0 bfd
   neighbor 192.168.253.13 peer group DC1_GW
   neighbor 192.168.253.13 description DC11_GW1
   neighbor 192.168.253.16 peer group DC1_GW
   neighbor 192.168.253.16 description DC11_GW2
...
| -------------- | --------------------- |
| Tenant_A | 11.1.255.15 |
| Tenant_B | 11.2.255.15 |

## Virtual Source NAT Configuration

```eos
!
ip address virtual source-nat vrf Tenant_A address 11.1.255.15
ip address virtual source-nat vrf Tenant_B address 11.2.255.15
```
