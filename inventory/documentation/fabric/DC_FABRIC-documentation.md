...
| --- | ---- | ---- | ------------- | -------- | -------------------------- |
| DC_FABRIC | l3leaf | gts478 | 172.28.131.18/20 | 7280R2 | Provisioned |
| DC_FABRIC | l3leaf | gts479 | 172.28.131.17/20 | 7280R2 | Provisioned |
| DC_FABRIC | l3leaf | gts480 | 172.28.131.11/20 | 7280R2 | Provisioned |
| DC_FABRIC | l3leaf | gts481 | 172.28.131.10/20 | 7280R2 | Provisioned |
| DC_FABRIC | l3leaf | hs447 | 172.28.132.64/20 | 7280R2 | Provisioned |
| DC_FABRIC | l3leaf | hs448 | 172.28.132.41/20 | 7280R2 | Provisioned |
| DC_FABRIC | l2dci | kn254 | 172.28.129.173/20 | Macsec | Provisioned |
| DC_FABRIC | l2dci | kn255 | 172.28.139.136/20 | Macsec | Provisioned |
| DC_FABRIC | l2dci | kn261 | 172.28.130.76/20 | Macsec | Provisioned |
| DC_FABRIC | l2dci | kn271 | 172.28.128.212/20 | Macsec | Provisioned |
| DC_FABRIC | spine | ph155 | 172.28.130.243/20 | default | Provisioned |
| DC_FABRIC | spine | ph156 | 172.28.130.244/20 | default | Provisioned |
| DC_FABRIC | spine | tg257 | 172.28.129.127/20 | default | Provisioned |
| DC_FABRIC | spine | tg294 | 172.28.129.4/20 | default | Provisioned |
...
| 150.5.0.0/24 | 256 | 2 | 0.79 % |
| 150.6.0.0/24 | 256 | 2 | 0.79 % |
...
| POD | Node | Loopback0 |
| --- | ---- | --------- |
| DC_FABRIC | gts478 | 150.3.0.3/32 |
| DC_FABRIC | gts479 | 150.3.0.4/32 |
| DC_FABRIC | gts480 | 150.3.0.5/32 |
| DC_FABRIC | gts481 | 150.3.0.6/32 |
| DC_FABRIC | hs447 | 150.3.0.7/32 |
| DC_FABRIC | hs448 | 150.3.0.8/32 |
| DC_FABRIC | kn254 | 150.5.0.1/32 |
| DC_FABRIC | kn255 | 150.5.0.2/32 |
| DC_FABRIC | kn261 | 150.6.0.1/32 |
| DC_FABRIC | kn271 | 150.6.0.2/32 |
| DC_FABRIC | ph155 | 150.9.0.3/32 |
| DC_FABRIC | ph156 | 150.9.0.4/32 |
| DC_FABRIC | tg257 | 150.9.0.1/32 |
| DC_FABRIC | tg294 | 150.9.0.2/32 |
...
| 8.8.8.0/32 | 1 | 0 | 0.0 % |
| 8.8.8.1/32 | 1 | 1 | 100.0 % |

## VTEP Loopback Node allocation

| POD | Node | Loopback1 |
| --- | ---- | --------- |
| DC_FABRIC | gts478 | 3.3.3.3/32 |
| DC_FABRIC | gts479 | 3.3.3.3/32 |
| DC_FABRIC | gts480 | 3.3.3.5/32 |
| DC_FABRIC | gts481 | 3.3.3.5/32 |
| DC_FABRIC | hs447 | 3.3.3.7/32 |
| DC_FABRIC | hs448 | 3.3.3.7/32 |
| DC_FABRIC | kn254 | 8.8.8.1/32 |
| DC_FABRIC | kn255 | 8.8.8.2/32 |
| DC_FABRIC | kn261 | 8.8.8.2/32 |
| DC_FABRIC | kn271 | 8.8.8.3/32 |
